(function(a){
    ...
    var Main = function(){
        ...
        this.view = {//krpano视角转动
            ...
            endH:0,//终点横坐标
            endV:0,//终点纵坐标
            point:[{h:1.921, v:0},{h:133.203, v:0},{h:216.242, v:0},{h:314.177, v:0},{h:67.206,v:13.234}]//多个需要转到的角度
        };
        ...
        this.block3 = {//厨师区域
            success:false,
            successStr:"你已收集到此处通关卡片，请寻找<br>其他互动区域",
            spotStr:["恭喜您成功选对材料：<br>安佳奶油干酪","恭喜您成功选对材料：<br>安佳黄油","您选的原材料是：安佳再制切达干酪，材料不对，请重新选择","您选的原材料是：安佳马苏里拉干酪，材料不对，请重新选择","芝士蛋挞"],
